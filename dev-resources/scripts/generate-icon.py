...
def generate_icon(output_path="assets/icon.png"):
    ...
    cone_size = 60
    draw.ellipse(
        [cone_x, cone_y, cone_x + cone_size, cone_y + cone_size],
        fill=(100, 150, 255),
        outline=(50, 100, 200),
        width=3,
    )
    ...
    cone_x2 = 150
    draw.ellipse(
        [cone_x2, cone_y, cone_x2 + cone_size, cone_y + cone_size],
        fill=(100, 150, 255),
        outline=(50, 100, 200),
        width=3,
    )
    ...
    for i in range(0, 30, 5):
        ...
        draw.rectangle(
            [x, y_center - bar_height // 2, x + 3, y_center + bar_height // 2],
            fill=(0, 255, 100),
            outline=(0, 200, 80),
            width=1,
        )
