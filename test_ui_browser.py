...
def test_choose_library_button_lowered():
    ...
    try:
        ...
        # Choose button should be moved further down in the rendered layout to avoid clipping
        # and should be at or below the setup-initial position (320)
        assert ui.config_choose_music_button.rect.y >= 320
    finally:
        pygame.quit()
